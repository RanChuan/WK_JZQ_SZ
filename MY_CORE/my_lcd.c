...
//			i=0;
			...
			if ((time_hour==LCD_POWER_HS)&&(time_min==LCD_POWER_SS)&&(time_sec<=15)) 
			{
					LCD_tosleep();
			}
			else if ((time_hour==LCD_POWER_HE)&&(time_min==LCD_POWER_SE)&&(time_sec<=15)) 
			{
				LCD_tolight();
			}
